...
export type GetBosScoresQuery = { __typename?: 'Query', getBosScores: Array<{ __typename?: 'BosScore', alias: string, public_key: string, score: number, updated: string, position: number }> };
