...
export type GetForwardsQuery = (
  ...
  & { getForwards?: Types.Maybe<(
    ...
    & Pick<Types.GetForwardType, 'token'>
    & { forwards?: Types.Maybe<Array<Types.Maybe<(
      { __typename?: 'forwardType' }
      & Pick<Types.ForwardType, 'created_at' | 'fee' | 'fee_mtokens' | 'incoming_channel' | 'mtokens' | 'outgoing_channel' | 'tokens'>
...
export function useGetForwardsQuery(baseOptions?: Apollo.QueryHookOptions<GetForwardsQuery, GetForwardsQueryVariables>) {
        return Apollo.useQuery<GetForwardsQuery, GetForwardsQueryVariables>(GetForwardsDocument, baseOptions);
      }
export function useGetForwardsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetForwardsQuery, GetForwardsQueryVariables>) {
          return Apollo.useLazyQuery<GetForwardsQuery, GetForwardsQueryVariables>(GetForwardsDocument, baseOptions);
        }
