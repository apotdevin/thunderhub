...
export type GetPendingChannelsQuery = { __typename?: 'Query', getPendingChannels?: Array<{ __typename?: 'pendingChannelType', close_transaction_id?: string | null | undefined, is_active: boolean, is_closing: boolean, is_opening: boolean, is_timelocked: boolean, local_balance: number, local_reserve: number, timelock_blocks?: number | null | undefined, timelock_expiration?: number | null | undefined, partner_public_key: string, received: number, remote_balance: number, remote_reserve: number, sent: number, transaction_fee?: number | null | undefined, transaction_id: string, transaction_vout: number, partner_node_info: { __typename?: 'Node', node: { __typename?: 'nodeType', alias: string, capacity?: string | null | undefined, channel_count?: number | null | undefined, color?: string | null | undefined, updated_at?: string | null | undefined } } } | null | undefined> | null | undefined };
